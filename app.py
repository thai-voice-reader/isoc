...
st.warning("👉 หากใช้งานผ่าน LINE: โปรดกด [ ⋮ ] มุมขวาบนหรือล่าง เลือก 'เปิดด้วยเบราว์เซอร์อื่น' เพื่อให้ดาวน์โหลดไฟล์ได้ปกติครับ")
...
# --- ส่วนรับข้อมูล ---
text_input = st.text_area("✍️ วางข้อความภาษาไทย และใช้คอมม่าร์คั่น เพื่อเว้นวรรคคำอ่าน", height=400, placeholder="ใส่ข้อความที่ต้องการให้อ่านที่นี่...")
